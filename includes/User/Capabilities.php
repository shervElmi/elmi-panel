...
namespace Sherv\Elmi_Panel\User;

use WP_Role;
use Sherv\Elmi_Panel\Infrastructure\{Service, Plugin_Activation};
 ...
 * @since 1.0.0
 */
class Capabilities implements Service, Plugin_Activation {
	 ...
	 * @var string
	 */
	const EDIT_ELMI_PANEL_CAP = 'edit_elmi-panel';
	...
	/**
	 * Adds Elmi Panel capabilities to default user roles.
	 *
	 * This gives WordPress site owners more granular control over Elmi Panel management,
	...
	public function add_caps_to_roles() {
		 ...
		 */
		do_action( 'elmi_panel_add_capabilities', $all_capabilities );
	}

	/**
	 * Removes Elmi Panel capabilities from all user roles.
	 *
	 * @since 1.0.0
	 *
	 * @return void
	...
	public function remove_caps_from_roles() {
		 ...
		 * @param array $all_capabilities List of all post type capabilities, for reference.
		 */
		do_action( 'elmi_panel_remove_capabilities', $all_capabilities );
	}
	...
	protected function get_all_capabilities(): array {
		return [ self::EDIT_ELMI_PANEL_CAP ];
	}
}
